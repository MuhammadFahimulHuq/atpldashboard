...
<div className=' border-b-2 border-gray-200'>
<div className='py-10 flex justify-between max-w-[800px]'>
<Label htmlFor="AlternativeEmail" className='font-bold text-gray-700'>Alternative Email</Label>
<div>
...
<div className=' border-b-2 border-gray-200'>
<div className='py-10 flex justify-between max-w-[800px]'>
<Label htmlFor="AlternativeEmail" className='font-bold text-gray-700'>Your Photo</Label>
<img className='rounded-full w-12 h-12' src={user?.profilePicture} alt={user?.fullName} />
<div className='flex gap-4'>
    <p className='text-gray-400 text-sm font-bold cursor-pointer'>Delete</p>
    <p className='text-primary text-sm font-bold cursor-pointer'>Update</p>
</div>
