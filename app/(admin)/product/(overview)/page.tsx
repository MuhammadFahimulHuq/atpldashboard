...
const ProductPage = () => {
  ...
  return (
    <div className="md:h-screen w-full bg-slate-100 rounded-lg md:rounded-l-3xl mt-4">
      <div className="p-4">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-4 mt-5">
          <Suspense fallback={<Loading />}>
            {products.map((product) => (
              <div
                className="h-full border-2 relative border-gray-200 border-opacity-60 rounded-xl bg-white overflow-hidden"
