...
const Topbar = () => {
  ...
  <DropdownMenuContent >
    ...
    <DropdownMenuItem  className='hover:bg-blue-100 '><Link href={'/profile'}>Profile</Link></DropdownMenuItem>
    <DropdownMenuItem className='cursor-pointer hover:bg-blue-100' onClick={handleLogout}>Logout</DropdownMenuItem>
